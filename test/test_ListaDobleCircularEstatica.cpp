...
#include "../src/Estructuras/Estaticas/ListaDobleCircularEstatica.hpp"

using namespace IS220::Estructuras::Estaticas;

TEST(ListaDobleCircularEstaticaTest, ListaVacia) {
	ListaDobleCircularEstaticaBase<int, 5> lista;
